...
.select {
	...
	<body>
		<div class="pd-20">
			<form  class="form form-horizontal" id="form-article-add" action="${pageContext.request.contextPath}/admin_admin.do?p=insertadmin" method="post" >
				<div class="row cl">
...
{	
	...
	if(gname==null || ""==gname)
	{
		layer.msg("请输入代理账号",{icon:6,time:1000});
		return false;
	}
