...
<![endif]-->
	...
	<body>
		...
		<span class="c-gray en">&gt;</span> 商品上架列表
		...
		<div class="pd-20">
			<div class="text-c">
				<form
					action="${pageContext.request.contextPath}/shangjiagoods.do?p=sjgoodslinting"
					method="post">
					...
					<tbody>
						<c:forEach items="${sjgoodsMap.list}" var="sj" varStatus="i">
							<tr class="text-c">
								...
								<td>
									<a style="text-decoration: none" onclick="member_show('${sj.gname}','shangjiagoods.do?p=checkGoodsImages&id=${sj.gid}','10001','1000','500')"
								...
								<td class="td-manage">
									...
									<a style="text-decoration: none" onclick="member_show('${sj.gname}','shangjiagoods.do?p=checkGoodsCoder&id=${sj.gid}','10001','300','300')"
							...
							<table width="100%" border="0" align="center" cellpadding="0"
								...
								<tr>
									...
									<td width="32%" align="right">
										[
										<a
											href="${pageContext.request.contextPath}/shangjiagoods.do?p=sjgoodslinting&gttid=${param.gttid}&minprice=${param.minprice}&maxprice=${param.maxprice}&keywords=${keywords}"
											class="right-font08">首页</a> |
										<a
											href="${pageContext.request.contextPath}/shangjiagoods.do?p=sjgoodslinting&gttid=${param.gttid}&minprice=${param.minprice}&maxprice=${param.maxprice}&keywords=${keywords}&page=${sjgoodsMap.page-1}"
											class="right-font08">上一页</a> |
										<a
											href="${pageContext.request.contextPath}/shangjiagoods.do?p=sjgoodslinting&gttid=${param.gttid}&minprice=${param.minprice}&maxprice=${param.maxprice}&keywords=${keywords}&page=${sjgoodsMap.page+1}"
											class="right-font08">下一页</a> |
										<a
											href="${pageContext.request.contextPath}/shangjiagoods.do?p=sjgoodslinting&gttid=${param.gttid}&minprice=${param.minprice}&maxprice=${param.maxprice}&keywords=${keywords}&page=${sjgoodsMap.count}"
...
{
	var url="${pageContext.request.contextPath}/shangjiagoods.do?p=xiugaistatus";
	var params={id:id};
...
function go(){
	window.location.href="${pageContext.request.contextPath}/shangjiagoods.do?p=sjgoodslinting&page=${sjgoodsMap.page}";
}
//批量下架
function plxiajia()
{
...
function viewGo()
{
	...
	if(page.match('^[0-9]*$'))
		{	
	window.location.href="${pageContext.request.contextPath}/shangjiagoods.do?p=sjgoodslinting&gttid=${param.gttid}&minprice=${param.minprice}&maxprice=${param.maxprice}&keywords=${keywords}&page="+page;
}
	}
