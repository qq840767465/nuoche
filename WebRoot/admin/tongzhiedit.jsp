...
<body>
<div class="pd-20">
<form action="${pageContext.request.contextPath}/tongzhi.do?p=edittongzhi&id=${tongzhi.tzid}" method="post" class="form form-horizontal" id="form-article-add" enctype="multipart/form-data">
	<div class="form form-horizontal" id="form-article-add">
		<div class="row cl">
			<label class="form-label col-2"><span class="c-red">*</span>通知标题：</label>
			<div class="formControls col-10">
				<input type="text" class="input-text" value="${tongzhi.tztitle}" placeholder="" id="tztitle" name="tztitle">
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-2">通知图片：</label>
      ...
      <img id="preview" src="${pageContext.request.contextPath}/${tongzhi.tzimages}" style="width: 180px; height: 200px;" />
		</div>
		<input type="hidden" name="tzdetail" id="tzdetail"/>
		<div class="row cl">
			<label class="form-label col-2">通知内容：</label>
			<div class="formControls col-10"> 
				<script id="editor"  type="text/plain" style="width:100%;height:200px;">${tongzhi.tzdetail}</script> 
			</div>
		</div>
		<div class="row cl">
