...
<body>
<div class="pd-20">
<form action="${pageContext.request.contextPath}/admin_moban.do?p=updatexiaoxilisting&id=${templatemessage.id}" method="post" class="form form-horizontal" id="form-article-add">
	<div class="form form-horizontal" id="form-article-add">
		<div class="row cl">
			<label class="form-label col-2">模板标题：</label>
			<div class="formControls col-10">
				<input type="text" class="input-text"  value="${templatemessage.tptitle}" placeholder="" id="tptitle" name="tptitle">
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-2">模板开头：</label>
			<div class="formControls col-10">
				<input type="text" class="input-text"  value="${templatemessage.tpstart}" placeholder="" id="tpstart" name="tpstart">
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-2">模板结尾：</label>
			<div class="formControls col-10"> 
				<input type="text" class="input-text" value="${templatemessage.tpending}" placeholder="" id="tpending" name="tpending">
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-2">模板链接：</label>
			<div class="formControls col-10">
				<input type="text" class="input-text" value="${templatemessage.tplink}" placeholder="" id="tplink" name="tplink">
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-2">模板参数：</label>
			<div class="formControls col-10"> 
				<input type="text" class="input-text" value="${templatemessage.tpparameters}" placeholder="" id="tpparameters" name="tpparameters">
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-2">模板含义：</label>
			<div class="formControls col-10"> 
				<input type="text" class="input-text" value="${templatemessage.tpmeaning}" placeholder="" id="tpmeaning" name="tpmeaning"> 
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-2">微信模板编号：</label>
			<div class="formControls col-10"> 
				<input type="text" class="input-text" value="${templatemessage.tpweixinId}" placeholder="请输入微信模板编号" id="tpweixin_id" name="tpweixin_id">
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-2">微信模板名称：</label>
			<div class="formControls col-10"> 
				<input type="text" class="input-text" value="${templatemessage.tpweixinName}" placeholder="请输入微信模板名称" id="tpweixin_name" name="tpweixin_name"> 
			</div>
		</div>
		<div class="row cl">
			<div class="col-10 col-offset-2">
				<button onclick="return add()" id="sub" class="btn btn-primary radius" type="submit"><i class="Hui-iconfont">&#xe632;</i> 修改信息</button>
			</div>
		</div>
	</div>
</form>
...
function add()
{
	...
	{
		layer.msg("模板参数为数字!",{icon:6,time:1500});
		$("#tpparameters").val("");
		return false;
	}
	
	if(tpmeaning==null || ""==tpmeaning)
	{
		layer.msg("请输入模板含义!",{icon:6,time:1500});
		return false;
	}
