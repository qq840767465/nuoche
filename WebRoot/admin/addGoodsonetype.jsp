...
<![endif]-->
<title>添加商品一级分类</title>
</head>
<body>
<div class="pd-20">
<form action="${pageContext.request.contextPath}/goodstypeback.do?p=addgoodsonetype" method="post" class="form form-horizontal" id="form-article-add" enctype="multipart/form-data" style="height: 391px; ">
    <div class="form form-horizontal" id="form-member-add" >
    <div class="row cl">
      <label class="form-label col-3"><span class="c-red">*</span>分类名称：</label>
      <div class="formControls col-5">
        <input type="text" class="input-text" onchange="yz_gtname()" placeholder="" id="gtname" name="gtname" >
      </div>
      <div class="col-4"> </div>
    </div>
    <div class="row cl">
		<label class="form-label col-3"><span class="c-red">*</span>分类LOGO：</label>
			 <input type="file" id="gtlogo" name="gtlogo" width="150px" runat="server" onchange="javascript:setImagePreview(this,localImag,preview);" />
			  <div id="localImag">
...
function yz_gtname()
{
	...
	var url="${pageContext.request.contextPath}/goodstypeback.do?p=checkgtname";
	var params={gtname:gtname};
...
function tijiao()
{
	var gtlogo=$("#gtlogo").val();
	var gtname=$("#gtname").val();
	if(gtname==null || ""==gtname)
	{
