...
<body>
<div class="pd-20">
<form action="${pageContext.request.contextPath}/notice.do?p=addNotice" method="post" class="form form-horizontal" id="form-article-add">
	<div class="form form-horizontal" id="form-article-add">
		...
		<div class="row cl">
			...
			<div class="formControls col-10">
				<input type="text" class="input-text" value="" placeholder="" id="noTitle" name="noTitle">
			</div>
		</div>
