...
<title>新增商品</title>
  ...
  <body>
  <div class="pd-20">
<form action="${pageContext.request.contextPath}/admin_corp.do?p=editcorplinsting&id=${corplisting.id}" method="post" class="form form-horizontal" id="form-article-add">
	<div class="form form-horizontal" id="form-article-add">
		...
		<div class="row cl">
			...
			<div class="formControls col-10"> 
				<script id="editor"  type="text/plain" style="width:100%;height:200px;">${corplisting.pscdesc}</script> 
