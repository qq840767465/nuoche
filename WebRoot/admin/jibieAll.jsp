...
<![endif]-->
	...
	<body>
		...
		<span class="c-gray en">&gt;</span> 级别所有列表
		...
		<div class="pd-20">
			...
			<div class="cl pd-5 bg-1 bk-gray mt-20">
			    <span class="l"><a
					...
					onclick="member_add('添加级别','${pageContext.request.contextPath}/admin/addJiBie.jsp','','510')"
					...
					<tbody>
						<c:forEach items="${jibiemap.list}" var="jb" varStatus="i">
							<tr class="text-c">
								...
								<td>
									<span class="label label-danger radius"><fmt:formatNumber value="${jb.djtuijiangli}" pattern="0.00"></fmt:formatNumber>元</span>
								</td>
								<td>
