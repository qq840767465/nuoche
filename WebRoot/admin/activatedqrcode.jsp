...
<![endif]-->
	...
	<body>
		...
		<span class="c-gray en">&gt;</span> 已激活二维码
		...
		<div class="pd-20">
			<div class="text-c">
				<form
					action="${pageContext.request.contextPath}/admin_erweima.do?p=activated"
					method="post">
					...
					<tbody>
						<c:forEach items="${qrcodemap.list}" var="list" varStatus="i">
							<tr class="text-c">
								...
								<td class="td-status">
									<span class="label label-defaunt radius">已激活</span>
								</td>
								<td class="td-manage">
									${list.proxy.realname }
								</td>
							...
							<table width="100%" border="0" align="center" cellpadding="0"
								...
								<tr>
									...
									<td width="32%" align="right">
										[
										<a
											href="${pageContext.request.contextPath}/admin_erweima.do?p=activated&keywords=${keywords}"
											class="right-font08">首页</a> |
										<a
											href="${pageContext.request.contextPath}/admin_erweima.do?p=activated&keywords=${keywords}&page=${qrcodemap.page-1}"
											class="right-font08">上一页</a> |
										<a
											href="${pageContext.request.contextPath}/admin_erweima.do?p=activated&keywords=${keywords}&page=${qrcodemap.page+1}"
											class="right-font08">下一页</a> |
										<a
											href="${pageContext.request.contextPath}/admin_erweima.do?p=activated&keywords=${keywords}&page=${qrcodemap.count}"
...
function viewGo()
{
	...
	if(page.match('^[0-9]*$'))
	{	
		window.location.href="${pageContext.request.contextPath}/admin_erweima.do?p=activated&keywords=${keywords}&page="+page;
	}
}
