...
<![endif]-->
	...
	<body>
		...
		<div class="pd-20">
			<div class="text-c">
				<form
					action="${pageContext.request.contextPath}/corp.do?p=corplisting"
					method="post">
							...
							<tr class="text-c">
								...
								<td class="td-manage">
									<a style="text-decoration: none"
										onclick="xiugai_status(this,${c.pscId})"
										...
										<a title="编辑" href="${pageContext.request.contextPath}/corp.do?p=corplinstingedit&id=${c.pscId}"
							...
							<table width="100%" border="0" align="center" cellpadding="0"
								...
								<tr>
									...
									<td width="32%" align="right">
										[
										<a
											href="${pageContext.request.contextPath}/corp.do?p=corplisting&keywords=${keywords}"
											class="right-font08">首页</a> |
										<a
											href="${pageContext.request.contextPath}/corp.do?p=corplisting&keywords=${keywords}&page=${corpmap.page-1}"
											class="right-font08">上一页</a> |
										<a
											href="${pageContext.request.contextPath}/corp.do?p=corplisting&keywords=${keywords}&page=${corpmap.page+1}"
											class="right-font08">下一页</a> |
										<a
											href="${pageContext.request.contextPath}/corp.do?p=corplisting&keywords=${keywords}&page=${corpmap.count}"
...
function xiugai_status(a,id) {
	var url = "${pageContext.request.contextPath}/corp.do?p=updatestatus";
	var param = {
		id : id
	};
...
function viewGo()
{
	...
	if(page.match('^[0-9]*$'))
		{	
	window.location.href="${pageContext.request.contextPath}/corp.do?p=corplisting&keywords=${keywords}&page="+page;
}
}
$(function() {
