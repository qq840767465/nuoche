...
<![endif]-->
	...
	<body>
		...
		<span class="c-gray en">&gt;</span> 删除回复消息
		...
		<div class="pd-20">
			<div class="cl pd-5 bg-1 bk-gray mt-20">
				<span class="l"> <a onclick="del10day()"
...
function deleteday()
{
	...
	layer.confirm('确认要删除吗？', function(index) {
			window.location.href="${pageContext.request.contextPath}/uamessages.do?p=deletemsg&type=4&status=1&day="+day;
			layer.msg('已删除!', {
				icon : 1,
				time : 1000
			});
...
function del10day(){
	layer.confirm('确认要删除吗？', function(index) {
			window.location.href="${pageContext.request.contextPath}/uamessages.do?p=deletemsg&type=5&status=1";
			layer.msg('已删除!', {
				icon : 1,
				time : 10000
			});
...
function del30day(){
	layer.confirm('确认要删除吗？', function(index) {
			window.location.href="${pageContext.request.contextPath}/uamessages.do?p=deletemsg&type=1&status=1";
			layer.msg('已删除!', {
				icon : 1,
				time : 10000
			});
...
function delbanyear(){
	layer.confirm('确认要删除吗？', function(index) {
			window.location.href="${pageContext.request.contextPath}/uamessages.do?p=deletemsg&type=2&status=1";
			layer.msg('已删除!', {
				icon : 1,
				time : 10000
			});
...
function delyear(){
	layer.confirm('确认要删除吗？', function(index) {
			window.location.href="${pageContext.request.contextPath}/uamessages.do?p=deletemsg&type=3&status=1";
			layer.msg('已删除!', {
				icon : 1,
				time : 10000
			});
