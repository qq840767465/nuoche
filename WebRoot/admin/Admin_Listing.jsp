...
<![endif]-->
	...
	<body>
		...
		<div class="pd-20">
			<div class="text-c">
								<form
					action="${pageContext.request.contextPath}/admin_admin.do?p=adminlisting"
					method="post" >
					...
					<tbody>
						<c:forEach items="${sjbusinessMap.list}" var="sj" varStatus="i">
							<tr class="text-c">
								...
								<td>
									<a href="${pageContext.request.contextPath}/admin_admin.do?p=xiugaipsd&id=${sj.id }"><span class="label label-success radius">修改密码</span></a>
								</td>
							...
							<table width="100%" border="0" align="center" cellpadding="0"
								...
								<tr>
									...
									<td width="32%" align="right">
										[
										<a
											href="${pageContext.request.contextPath}/admin_admin.do?p=adminlisting&keywords=${keywords}"
											class="right-font08">首页</a> |
										<a
											href="${pageContext.request.contextPath}/admin_admin.do?p=adminlisting&keywords=${keywords}&page=${sjbusinessMap.page-1}"
											class="right-font08">上一页</a> |
										<a
											href="${pageContext.request.contextPath}/admin_admin.do?p=adminlisting&keywords=${keywords}&page=${sjbusinessMap.page+1}"
											class="right-font08">下一页</a> |
										<a
											href="${pageContext.request.contextPath}/admin_admin.do?p=adminlisting&keywords=${keywords}&page=${sjbusinessMap.count}"
