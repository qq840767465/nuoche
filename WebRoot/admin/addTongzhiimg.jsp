...
<body>
<div class="pd-20">
<form action="${pageContext.request.contextPath}/tongzhiimages.do?p=addtongzhiimg" method="post" class="form form-horizontal" id="form-article-add" enctype="multipart/form-data">
	<div class="form form-horizontal" id="form-article-add">
		<div class="row cl">
			<label class="form-label col-2">轮播状态：</label>
			<div class="formControls col-2"> <span class="select-box">
				<select class="select" id="tzimgstatus" name="tzimgstatus">
