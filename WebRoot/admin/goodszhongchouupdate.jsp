					...
					<c:if test="${type==2}">
						<div class="row cl">
							...
							<div class="formControls col-10">
								<input type="text" class="input-text" value="${zhong.goods.gname}" readonly="readonly" placeholder="" id="gname" name="">
							</div>
						</div>
						<div class="row cl">
								<label class="form-label col-2"><span class="c-red">*</span>商品折扣：</label>
							<div class="formControls col-3">
								<input type="text" onkeyup="this.value=(this.value.match(/\d+(\.\d{0,2})?/)||[''])[0]" class="input-text" value="${zhong.gcfrRebate}"  placeholder="" id="gcfrRebate" name="">
							</div>
						</div>
						<div class="row cl">
								<label class="form-label col-2"><span class="c-red">*</span>开始重量：</label>
							<div class="formControls col-3">
								<input type="text" onkeyup="this.value=this.value.replace(/\D/g,'')" class="input-text" value="${zhong.gcfrBeginkg}"  placeholder="" id="gcfrBeginkg" name="">
							</div>
						</div>
						<div class="row cl">
								<label class="form-label col-2"><span class="c-red">*</span>结束重量：</label>
							<div class="formControls col-3">
								<input type="text" onkeyup="this.value=this.value.replace(/\D/g,'')" class="input-text" value="${zhong.gcfrEndkg}"  placeholder="" id="gcfrEndkg" name="">
							</div>
						</div>
...
function setrebate()
{
	...
	$.ajax({
		url:"${pageContext.request.contextPath}/zhongchougoods.do?p=updaterebate&id=${goods.gid}",
		type:"post",
