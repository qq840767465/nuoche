...
<body>
<div class="pd-20">
<form action="${pageContext.request.contextPath}/lunboimg.do?p=addlunboimg" method="post" class="form form-horizontal" id="form-article-add" enctype="multipart/form-data">
