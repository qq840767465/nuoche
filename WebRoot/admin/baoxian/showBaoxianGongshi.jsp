...
<![endif]-->
	...
	<body>
		...
		<span class="c-gray en">&gt;</span> 保险公司管理
		<span class="c-gray en">&gt;</span> 保险公司列表
		</nav>
		<div class="pd-20">
					...
					<tbody>
						<c:forEach items="${list}" var="c" varStatus="i">
							<tr class="text-c">
								...
								<td>
									<img src="${pageContext.request.contextPath}/${c.logo}" width="50px" height="50px"/>
								</td>
								<td>
									<c:if test="${c.status==0}" var="f">
								...
								<td class="td-manage">
									<a style="text-decoration: none"
										...
										<a title="编辑" href="${pageContext.request.contextPath}/admin_baoxian.do?p=toUpdateView&id=${c.id}"
...
function xiugai_status(a,id) {
	var url = "${pageContext.request.contextPath}/admin_baoxian.do?p=updatestatus";
	var param = {
		id : id
	};
