...
<body>
	<div class="pd-20">
		<form
			action="${pageContext.request.contextPath}/admin_baoxian.do?p=updateBaoxianGongshi&id=${b.id}"
			...
			<div class="form form-horizontal" id="form-article-add">
				<div class="row cl">
					...
					<div class="formControls col-10">
						<input type="text" class="input-text"
							value="${b.name}" placeholder="" id="name"
							name="name">
					</div>
				</div>
				
				<div class="row cl">
					<label class="form-label col-2"><span class="c-red"></span>openid1：</label>
					<div class="formControls col-10">
						<input type="text" class="input-text"
							value="${b.openid1}" placeholder="" id="name"
							name="openid1">
					</div>
				</div>
				
				<div class="row cl">
					<label class="form-label col-2"><span class="c-red"></span>openid2：</label>
					<div class="formControls col-10">
						<input type="text" class="input-text"
							value="${b.openid2}" placeholder="" id="name"
							name="openid2">
					</div>
				</div>
				...
				<div class="row cl">
					<label class="form-label col-2"><span class="c-red"></span>openid3：</label>
					<div class="formControls col-10">
						<input type="text" class="input-text"
							value="${b.openid3}" placeholder="" id="name"
							name="openid3">
					</div>
				</div>
				...
				<div class="row cl">
					<label class="form-label col-2"><span class="c-red"></span>openid4：</label>
					<div class="formControls col-10">
						<input type="text" class="input-text"
							value="${b.openid4}" placeholder="" id="name"
							name="openid4">
					</div>
				</div>
				...
				<div class="row cl">
					<label class="form-label col-2"><span class="c-red"></span>openid5：</label>
					<div class="formControls col-10">
						<input type="text" class="input-text"
							value="${b.openid5}" placeholder="" id="name"
							name="openid5">
					</div>
				</div>
				...
				<div class="row cl">
					<label class="form-label col-2">轮播图片：</label> <input type="file"
						id="img" name="logo" width="150px" runat="server"
					...
					<div id="localImag">
						...
						<img id="preview"
							src="${pageContext.request.contextPath}/${b.logo}"
