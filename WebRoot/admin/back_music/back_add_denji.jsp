...
<html>
	...
	<body>
		...
		<nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span> 歌曲管理 <span class="c-gray en">&gt;</span> 新增歌曲等级</nav>
		<form action="" method="post" class="form form-horizontal">
			...
			<div class="row cl">
				...
				<div class="formControls col-xs-8 col-sm-7">
					<input type="text" class="input-text" value="" placeholder="请输入0-1间小数"
...
function add_lunbo(){
	...
	$.ajax({
		url: '${pageContext.request.contextPath }/musicBack.do?p=addDenji',
		type:'POST',
		data: {name:name,status:status,zhekou:zhekou},
