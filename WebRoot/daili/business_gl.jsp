...
<![endif]-->
	...
	<body>
		...
		<div class="pd-20">
			<div class="text-c">
								<form
					action="${pageContext.request.contextPath}/daili_business.do?p=storessj"
					method="post" >
							...
							<table width="100%" border="0" align="center" cellpadding="0"
								...
								<tr>
									...
									<td width="32%" align="right">
										[
										<a
											href="${pageContext.request.contextPath}/daili_business.do?p=storessj&keywords=${keywords}"
											class="right-font08">首页</a> |
										<a
											href="${pageContext.request.contextPath}/daili_business.do?p=storessj&keywords=${keywords}&page=${sjbusinessMap.page-1}"
											class="right-font08">上一页</a> |
										<a
											href="${pageContext.request.contextPath}/daili_business.do?p=storessj&keywords=${keywords}&page=${sjbusinessMap.page+1}"
											class="right-font08">下一页</a> |
										<a
											href="${pageContext.request.contextPath}/daili_business.do?p=storessj&keywords=${keywords}&page=${sjbusinessMap.count}"
...
function viewGo()
{
	...
	if(page.match('^[0-9]*$'))
		{	
	window.location.href="daili_business.do?p=storessj&keywords=${keywords}&page="+page;
}
	}
