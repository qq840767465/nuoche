...
<script type="text/javascript" src="${pageContext.request.contextPath }/daili/js/login.js"></script>
</head>
   ...
   <div class="login_center">
         ...
         <div class="login_users">
               <div class="login_yhdl">
                    <div class="login_begin"><b class="login_beginimg"></b><span class="login_userneirong">代理管理员登录</span></div>
               </div>
               <form target="_top" action="${pageContext.request.contextPath }/dailiLoginBack.do?p=login" method="post">
               <table>
