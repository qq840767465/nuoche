		...
		<div class="pd-20">
			<form class="form form-horizontal" id="form-article-add">
				...
				<div class="row cl">
					...
					<div class="formControls col-10">
						<input type="text" class="input-text" 
							value="${b.shopname }" placeholder="" id="gname" name="gname" />
					</div>
				</div>
				<div class="row cl">
					<label class="form-label col-2">
				...
				<div class="row cl">
					...
					<div class="formControls col-10">
						<input type="text" class="input-text" value="${b.shopaddr }" placeholder=""
				...
				<div class="row cl">
					...
					<div class="formControls col-4">
						<input type="text"
							name="gprice" id="gprice" placeholder="" value="${b.email }"
							class="input-text">
					</div>
				</div>
				<!-- <div class="row cl" style="display: none;">
					...
					<div class="formControls col-2">
						<span class="select-box"> <select class="select"
								name="gvipprice" id="gvipprice">
								<option value="洗车"  selected="selected">
									洗车
								</option>
								<option value="维修" >
									维修
				...
				<div class="row cl" style="display: block">
					<label class="form-label col-2"><span class="c-red">*</span>店铺图片：</label>
					  <input type="hidden" id="cimages" name="cimages" width="200px" runat="server" onchange="javascript:setImagePreview(this,localImag,preview);" />
					  <div class="formControls col-2"  id="localImag"><div class="uploader-thum-container">
							<div id="fileList" class="uploader-list"></div>
							<div class="default">
								<img id="preview" src="${pageContext.request.contextPath}/${b.shoplogo}"
...
/* 	var gname=(document.getElementById("gname").value);
	...
	layer.confirm("修改店铺？",function(index){
	   $.post(
	      ...
	      "${pageContext.request.contextPath}/daili_business.do?p=updatetwo",
	       {
	           gid:"${b.id}",
	           gname:gname,
	           gchandi:gchandi,
...
//----------------------------------22222222-------------------------------
	...
	uploader.on( 'uploadSuccess', function( file ,response) {
		...
		$("#preview").attr("src","${pageContext.request.contextPath}/"+image2);
		$("#current").find("img").css({"height":"100%","width":"100%","margin-top":"0px"});
