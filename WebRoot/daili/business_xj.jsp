...
<![endif]-->
	...
	<body>
		...
		<span class="c-gray en">&gt;</span> 商家列表
		...
		<div class="pd-20">
			<div class="text-c">
								<form
					action="${pageContext.request.contextPath}/daili_business.do?p=storesxj"
					method="post" >
					<input type="text" name="keywords" class="input-text"
						style="width: 250px" value="${keywords}" placeholder="输入店铺名称">
					<button type="submit" class="btn btn-success radius" >
						<i class="Hui-iconfont">&#xe665;</i> 搜索店铺
					</button>
				</form>
			</div>
					...
					<tbody>
						<c:forEach items="${sjbusinessMap.list}" var="sj" varStatus="i">
							<tr class="text-c">
								...
								<td class="td-manage">
									<c:if test="${sj.status ==2}">
									<a style="text-decoration: none" onclick="xiugai_status(this,${sj.id})"
									href="javascript:void(0)" title="上架商品">
										<span class="label label-success radius">上架</span>
									</a>
									</c:if>
									<a style="text-decoration: none" onclick="article_edit('编辑','daili_business.do?p=updateone&id=${sj.id}&page=${sjgoodsMap.page}','10001')"
							...
							<table width="100%" border="0" align="center" cellpadding="0"
								...
								<tr>
									...
									<td width="32%" align="right">
										[
										<a
											href="${pageContext.request.contextPath}/daili_business.do?p=storesxj&keywords=${keywords}"
											class="right-font08">首页</a> |
										<a
											href="${pageContext.request.contextPath}/daili_business.do?p=storesxj&keywords=${keywords}&page=${sjbusinessMap.page-1}"
											class="right-font08">上一页</a> |
										<a
											href="${pageContext.request.contextPath}/daili_business.do?p=storesxj&keywords=${keywords}&page=${sjbusinessMap.page+1}"
											class="right-font08">下一页</a> |
										<a
											href="${pageContext.request.contextPath}/daili_business.do?p=storesxj&keywords=${keywords}&page=${sjbusinessMap.count}"
...
{
	var url="${pageContext.request.contextPath}/daili_business.do?p=xiugaistatus";
	var params={id:id};
...
function go(){
	window.location.href="${pageContext.request.contextPath}/daili_business.do?p=storessj";
}
//批量下架
function plxiajia()
{
	...
	layer.confirm("确定要上架吗",function(index){
		$.ajax({
		url:"${pageContext.request.contextPath}/daili_business.do?p=plshangjiagoods",
		type:"post",
...
function viewGo()
{
	...
	if(page.match('^[0-9]*$'))
		{	//${pageContext.request.contextPath}/daili_business.do?p=storesxj&keywords=${keywords}&page=${sjbusinessMap.page+1}
	window.location.href="${pageContext.request.contextPath}/daili_business.do?p=storesxj&keywords=${keywords}&page"+page;
}
	}
