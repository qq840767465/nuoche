				...
				<li >
					...
					<span class="fill_inBs" id="" style="height: 100%; " >
						...
						<li><!-- 20171116 新增 -->
							...
							<span class="fill_inBs" style="color: #999" id="price">${price }<span style="float: right;">&nbsp;元</span></span>
							
						</li>
					
				<li>
					<span class="fill_inA">合计金额：</span>
					<span class="fill_inBs" id="totalPrice" >${price }元</span>
				</li>
				<li>
					<span class="fill_inA">获取方式：</span>
					<span class="fill_inB" style="text-align: right;">
							快递发货
						</span>
				</li>
			</ul>
...
function next(){	
	...
	window.location.href="${pageContext.request.contextPath }/applyforqrcode.do?method=submitnum&account="+account+"&sum="+sum;
