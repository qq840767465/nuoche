...
<html>
	...
	<style>
		...
		.box-a {
			...
			height: 150px;
			text-align: center;
			background-image: url(${pageContext.request.contextPath}/weixin/images/muwu.jpg);
	...
	<body>
		<header id="header" class="mui-bar mui-bar-nav nav-header" style="background-color: #FF7900;">
			<h1 class="mui-title" style="text-align: center;background-color: #FF7900;color: white;">个人中心</h1>
		</header>
		<div class="mui-content">
			<!-- 这里是未登录 -->
			<div class="userinfo" id="login">
				<img src="${pageContext.request.contextPath}/weixin/img/ve.png" style="border-radius:30px;" />
				<p class="userName">
					立即登录
				</p>
			...
			<div class="userinfo" id="userinfo" style="display: none;">
				<img src="${pageContext.request.contextPath}/weixin/img/ve.png" id="edit_img" style="border-radius:30px;" />
				<p class="userName">
				</p>
			</div>
			<div class="box-b" id="jifen" style="display: none;">
				<button id='alertBtn' type="button" class="mui-btn mui-btn-blue mui-btn-outlined">我的积分:1005</button>
			</div>
			<div class="box-c">
				<div class="box-c-1" id="Top-Up">
					<div class="box-c-2"><img src="${pageContext.request.contextPath}/weixin/img/center/chongzhi.png"></div>
					<p>充值中心</p>
				</div>
				<div class="box-c-1">
					<div class="box-c-2" id='goods-order'><img src="${pageContext.request.contextPath}/weixin/img/center/order.png"></div>
					<p>商品订单</p>
				</div>
				<div class="box-c-1">
					<div class="box-c-2" id='address'><img src="${pageContext.request.contextPath}/weixin/img/center/address.png"></div>
					<p>收货地址</p>
				</div>
				<div class="box-c-1">
					<div class="box-c-2" id="collection"><img src="${pageContext.request.contextPath}/weixin/img/center/details.png"></div>
					<p>我的收藏</p>
				</div>
				<div class="box-c-1" id="systemmessage">
					<div class="box-c-2"><img src="${pageContext.request.contextPath}/weixin/img/center/dianpu.png"></div>
					<p>系统消息</p>
				</div>
				<div class="box-c-1" id="gonggao">
					<div class="box-c-2"><img src="${pageContext.request.contextPath}/weixin/img/center/shezhi.png"></div>
					<p>系统公告</p>
				</div>
				<div class="box-c-1" id="tongzhi">
					<div class="box-c-2"><img src="${pageContext.request.contextPath}/weixin/img/center/address.png"></div>
					<p>通知</p>
				</div>
				<div class="box-c-1" id="xiaxian">
					<div class="box-c-2"><img src="${pageContext.request.contextPath}/weixin/img/center/tuandui.png"></div>
					<p>已推荐的会员</p>
				</div>
				<div class="box-c-1" id="erweima">
					<div class="box-c-2"><img src="${pageContext.request.contextPath}/weixin/img/center/record.png"></div>
					<p>我的二维码</p>
				</div>
				<!--
				...
				<div class="box-c-1" id="zhuxiao_login">
					<div class="box-c-2"><img src="${pageContext.request.contextPath}/weixin/images/user-photo.png"></div>
					<p>注销</p>
				</div>
				<div class="box-c-1" id="guanyume">
					<div class="box-c-2"><img src="${pageContext.request.contextPath}/weixin/images/i-wo.png"></div>
					<p>关于我们</p>
				</div>
			</div>
			<script type="text/javascript">
				...
				var userid = '${weixinuser.userinfo.usersId}'; //会员ID
				var userPhone = '${weixinuser.userinfo.usersPhone}'; //会员手机号码
				//会员登录成功后自定义事件
				...
				function Usershow(Userinfo) {
					...
					//如果用户未设置头像则用默认头像
					if('${weixinuser.userinfo.usersHeadimg}' != "") {
						$('#userinfo').find('img').attr('src', "${pageContext.request.contextPath}/${weixinuser.userinfo.usersHeadimg}"); //用户头像
					} else {
						$('#userinfo').find('img').attr('src', "${weixinuser.headimgurl}"); //用户头像	
					}
				...
				**/
				...
				window.onload = function (){
					...
					if(username != null && userpwd != null) {
						mui.post("${pageContext.request.contextPath}/" + "applogin.do?p=applogin", {
								username: username,
								userpwd: userpwd
							}, function(data) {
								if(data == "请先登录") {
					...
					$("#zhuxiao_login").click(function() {
						mui.confirm("确定要注销吗？", function(e) {
							if(e.index == 1) {
								mui.post("${pageContext.request.contextPath}/" + "weixin_login.do?p=zhuxiao", {}, function(data) {
