...
<html>
	...
	<body>
		<header class="mui-bar mui-bar-nav" style="background-color:#FF7900;margin-top: 0px;">
			...
			<a href="javascript:void(0)" class="xiugai" onclick="adddianpu()">完成</a>
		</header>
		<div class="mui-content">
			<div class="hang" style="height: 58px;">
				<span class="zi">店铺名称：</span>
				<input  type="text" class="shuchu" id="shopname" style="height: 38px;line-height: 19px;font-size: 12px;width: 60%;border:0px;"/>
				 
			</div>
			<div class="hang" style="height: 58px;">
				<span class="zi">电&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;话：</span>
	            <input type="text" class="shuchu" id="shoptel" style="height: 38px;line-height: 19px;font-size: 12px;width: 60%;border:0px;"/>
			</div>
			<div class="hang3" style="height: 58px;">
				<span class="zi">地&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;址：</span>
				<select class="xiala" id="sheng" onchange="getShi()" style="background-color: #ffffff;">
				</select>
				<select class="xiala" id="shi" onchange="getXian()" style="background-color: #ffffff;">
				</select>
				<select class="xiala" id="xian" style="background-color: #ffffff;">
 				</select>
			</div>
			<div class="hang" style="height: 58px;">
				<span class="zi">详细地址：</span>
	            <input type="text" class="shuchu" id="address" style="height: 38px;line-height: 19px;font-size: 12px;width: 60%;border:0px;"/>
			</div>
			<div class="hang3" style="height: 58px;">
				<span class="zi">类&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;别：</span>
	            <select class="xiala zi" id="shoptype" style="background-color: #ffffff;">
			...
			<div class="hang3" style="height: 58px;">
	            ...
	            <select class="xiala zi" id="shopstate" style="background-color: #ffffff;">
			...
			<div class="hang" style="height: 58px;">
	            ...
	            <input type="text" class="shuchu" id="jieshao" style="height: 38px;line-height: 19px;font-size: 12px;width: 60%;border:0px;"/>
			</div>
			<div class="hang2">
				<span class="zi">店铺详情：</span>
	            <textarea style="border: 0px;" id="xiangqing" class="zi"></textarea>
			</div>
			<div class="hang2">
				<span class="zi2">店铺照片：</span>
	            <div index=0 class="fimage">
					 <img width="40px" height="40px" src="${pageContext.request.contextPath }/weixin/images/add.png"/>
				</div>
			</div>
    ...
    onload = function()
    {
       ...
       request.send(null);
		...
		function adddianpu(){
		    ...
		    layer.confirm("添加店铺？",function(index){
	         $.post("${pageContext.request.contextPath}/wapUser.do?p=adddianpu",
	         {
	           shopname:shopname,
	           shoptel:shoptel,
	           IDimage:IDimage,
	         ...
	         function(){
               layer.msg('添加成功',{inco:1,time:1000},function(){
                  //location.reload();
