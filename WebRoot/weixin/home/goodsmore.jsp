...
<script src="${pageContext.request.contextPath}/weixin/js/jquery-1.9.0.min.js" type="text/javascript" charset="utf-8"></script>
	</head>
	...
	<body>
		<header class="mui-bar mui-bar-nav" style="background: #FF7900;">
			...
			<span id="gtname" class="mui-btn-link" style="color: white;">米禾分类</span>
		</header>
			...
			<div class="mui-content mui-scroll-wrapper" id="pullrefresh">	
				...
				<ul id="goodsmorelist" class="mui-table-view mui-table-view-chevron"" >
					<!--<li>
		...
		<script type="text/javascript">
			...
			mui(document).on("tap","li",function(){
						...
						mui.post(url, {
							...
							function(data) {
								...
								for(var i = 0; i < map.twoList.length; i++) {
									...
									goodsli.id = map.twoList[i].gttId;
									$(goodsli).attr("id2",map.twoList[i].gttName);
