	...
	<body>
		...
		<script>
			...
			function xiugai_status(a,id){
								...
								var url = "${pageContext.request.contextPath}/sjyuyuerecord.do?p=updatestatus";
								var param = {
									id : id
								};
								$.post(url, param, function(data) {
									if(data=="1")
										{
												a.innerHTML='<button class="label label-defaunt radius">未服务</button>';
											alert("已修改成未服务");
										}
										else{
										
										
											a.innerHTML='<button class="label label-success radius">已服务</button>';
											alert("已修改成已服务");
										}
