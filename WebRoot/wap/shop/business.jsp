...
<html>
	...
	<body>
		...
		<script src="${pageContext.request.contextPath}/wap/js/url.js"></script>
		<script src="${pageContext.request.contextPath}/wap/js/jquery-1.9.0.min.js"></script>
...
//									goodsli.style.padding = '0px';
			...
			function goumai(gprice,userid,gid,gname,gimages,gdanwei) {
				if(userid != null) {
				window.top.location = "${pageContext.request.contextPath}/weixin/goodsdetail/ljgm-order.jsp?userid="+userid+"&gprice="+gprice+"&gname="+gname+"&gimages="+gimages.substring(gimages.indexOf("/admin")+1)+"&gid="+gid+"&gdanwei="+gdanwei;
			} else {
				goLogin();
			}
			}
