				...
				<ul class="fillList lineHeightA">
								...
								<li>
									...
									<span class="fill_inB"><input type="tel" placeholder="请输入" 
										name="tel" id="tel" maxlength="11" onkeyup="doTelValid(this)"></span>
		...
		$.ajax({
			...
			success:function(jd){
				if(jd=="1"){
					...
					window.location.replace("${pageContext.request.contextPath }/useryuyueRecord.do?p=index&openid=${weixinhao}");
				}else{
					showPopWin(1,"绑定失败！");
				}				
			},
