 ...
 */
@Controller
@RequestMapping("/weixinpayAbout.do")
public class WeiXinAboutpayAction {
	...
	public String payNotify(HttpServletResponse response) throws IOException {
		...
		if ("SUCCESS".equals(payNotify.getResult_code())
			...
			// 将提现金额加入余额中
			//dailichongzhipayservice.updatefeeByOrderid(trade_no);
	...
	public String toPay(HttpServletResponse response) {
		...
		// 2.去支付
		String notifyUrl = URLManager.getServerURL(request)+ "/weixinpayAbout.do";
