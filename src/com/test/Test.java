...
public class Test {
	 public static void main(String[] args) throws Exception {
		   ...
		   String sign = MD5Util.getMD5(paramString+url+md5key).toLowerCase();
		   
		   String callUrl = SERVER_URL+paramString+returnUrl+"&sign="+sign+"&params=1234";
